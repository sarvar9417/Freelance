...
const COURSES: Record<string, CourseDetail> = {
  '1': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3, title: "Upwork profil yaratish",         duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4, title: "Fiverr gig sozlash",             duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5, title: "Birinchi proposal yozish",       duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6, title: "Mijoz bilan muloqot sirlari",    duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7, title: "Narx belgilash strategiyasi",    duration: '20 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8, title: "Portfolio yaratish",             duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9, title: "Shartnoma va to'lov",            duration: '18 daqiqa',   free: true, completed: false },
      { id: 'l10',order:10, title: "Reytingni oshirish",             duration: '22 daqiqa',   free: true, completed: false },
      { id: 'l11',order:11, title: "Passiv daromad",                 duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l12',order:12, title: "Xulosa va keyingi qadamlar",     duration: '15 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '2': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3, title: "Auto Layout bilan ishlash",            duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4, title: "Component va Variant sistemasi",       duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5, title: "Typography va Color Systems",          duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6, title: "Prototiplash va animatsiya",           duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7, title: "Design Tokens va stil kutubxonasi",    duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8, title: "Mobile va Desktop responsive dizayn",  duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9, title: "Jamoa bilan ishlash va Handoff",       duration: '22 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '3': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "AIDA formulasi amalda",                  duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "PAS va BAB formulalari",                 duration: '22 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "Sarlavha va CTA yozish sirlari",         duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "Landing page copywriting",               duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "Email marketing copywriting",            duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "Social media uchun matn yozish",         duration: '20 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "SEO va kalit so'zlar bilan ishlash",     duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "Xulosa: portfolio va narx belgilash",   duration: '20 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '4': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "Kontent strategiyasi va editorial plan",      duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "Instagram Reels va Stories sirlari",          duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "TikTok uchun viral kontent yaratish",         duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "Hashtag strategiyasi va tahlil",              duration: '20 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "Meta Ads: Facebook va Instagram reklama",     duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "Influencer marketing va hamkorliklar",        duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "Analytics va KPI hisoblash",                  duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "SMM manager sifatida mijoz topish",          duration: '22 daqiqa',   free: true, completed: false },
      { id: 'l11', order: 11, title: "Case study: real biznes uchun SMM",          duration: '35 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '5': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "CSS3: Selectors va Box Model",                duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "CSS Flexbox — to'liq qo'llanma",              duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "CSS Grid Layout — zamonaviy grid tizimi",     duration: '45 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "Responsive dizayn va Media Queries",          duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "CSS Animatsiya va Transitions",               duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "CSS Custom Properties (Variables)",           duration: '22 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "SASS/SCSS — CSS preprocessor",               duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "Tailwind CSS bilan tez ishlash",            duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l11', order: 11, title: "HTML/CSS bilan landing page yaratish",      duration: '55 daqiqa',   free: true, completed: false },
      { id: 'l12', order: 12, title: "Web accessibility va SEO asoslari",         duration: '25 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '6': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "Destructuring, Spread va Rest operatorlar",   duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "DOM manipulyatsiya va hodisalar",             duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "Massivlar bilan ishlash: map, filter, reduce", duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "Obyektlar va Prototype zanjiri",              duration: '32 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "Promises va asinxron dasturlash",             duration: '38 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "Async/Await bilan ishlash",                  duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "Fetch API va REST API bilan ishlash",         duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "Modullar va ES6 Import/Export",             duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l11', order: 11, title: "Local Storage va Session Storage",          duration: '22 daqiqa',   free: true, completed: false },
      { id: 'l12', order: 12, title: "Loyiha: To-Do ilovasi yaratish",           duration: '60 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '7': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "Shape Builder va Pathfinder",                duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "Typography va shrift tanlash",               duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "Logotip dizayn — bosqichma-bosqich",         duration: '60 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "Rang palitrasini tanlash va brending",       duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "Brendbuk va brand identity yaratish",        duration: '50 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "Mock-up va prezentatsiya tayyorlash",        duration: '30 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '8': {
    ...
    longDescription: "Bu kursda siz CapCut va Adobe Premiere Pro dasturlarida professional video montaj qilishni o'rganasiz. Videolarni kesish, effektlar qo'shish, rang korreksiyasi, ovoz bilan ishlash va eksport qilish jarayonlari to'liq yoritilgan.",
    ...
    lessons: [
      { id: 'l1', order: 1, title: "Video montajga kirish va dasturlar",     duration: '15 daqiqa', free: true,  completed: false },
      { id: 'l2', order: 2, title: "CapCut interfeysi va asosiy sozlamalar", duration: '20 daqiqa', free: true, completed: false },
      { id: 'l3', order: 3, title: "Videolarni kesish va birlashtirish",     duration: '25 daqiqa', free: true, completed: false },
      { id: 'l4', order: 4, title: "Effektlar va Transitionlar",             duration: '30 daqiqa', free: true, completed: false },
      { id: 'l5', order: 5, title: "Ovoz bilan ishlash va musqa qo'shish",  duration: '22 daqiqa', free: true, completed: false },
      { id: 'l6', order: 6, title: "Matn va subtitr qo'shish",              duration: '20 daqiqa', free: true, completed: false },
      { id: 'l7', order: 7, title: "Rang korreksiyasi va filtrlash",        duration: '28 daqiqa', free: true, completed: false },
      { id: 'l8', order: 8, title: "Premiere Pro'ga kirish",                duration: '35 daqiqa', free: true, completed: false },
      { id: 'l9', order: 9, title: "Premiere Pro'da rang korreksiyasi",      duration: '30 daqiqa', free: true, completed: false },
      { id: 'l10', order: 10, title: "Keyframe animatsiyasi",               duration: '25 daqiqa', free: true, completed: false },
      { id: 'l11', order: 11, title: "Loyiha eksporti va formatlar",         duration: '20 daqiqa', free: true, completed: false },
    ],
    whatYouLearn: [
      "CapCut va Premiere Pro dasturlarida ishlash",
      "Videolarni professional darajada montaj qilish",
      "Effektlar, transitionlar va animatsiyalar qo'shish",
      "Rang korreksiyasi va audio bilan ishlash",
      "Social media uchun video tayyorlash",
      "Portfolio yaratish va mijoz topish",
    ],
    requirements: ["Kompyuter (Windows yoki Mac)", "CapCut (bepul) yoki Premiere Pro", "Montajga qiziqish"],
    students: 198, rating: 4.8, tasks: 3,
    language: "O'zbek tili", lastUpdated: "2025-mart",
    enrolled: false, progress: 0,
  },
  '9': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "Rasmlarni tahrirlash va retush qilish",         duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "Adobe Illustrator: Interfeys va asosiy asboblar", duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "Vektor grafika va Pen Tool o'zlashtirish",     duration: '45 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "Logo dizayn yaratish — bosqichma-bosqich",     duration: '60 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "Brending: brand identity va brendbuk",         duration: '50 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "Rang nazariyasi — professional dizayner siri", duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "Tipografiya: shrift tanlash va kompozitsiya",  duration: '32 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "Mijoz bilan ishlash: brief va muloqot",      duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l11', order: 11, title: "Reviziya va feedback bilan ishlash",         duration: '20 daqiqa',   free: true, completed: false },
      { id: 'l12', order: 12, title: "Portfolio yaratish va ish namunalarini tayyorlash", duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l13', order: 13, title: "Behance va Dribbble'da profil yaratish",    duration: '22 daqiqa',   free: true, completed: false },
      { id: 'l14', order: 14, title: "Upwork va Fiverr'da dizayner sifatida ishlash", duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l15', order: 15, title: "Narx belgilash va muzokaralar",             duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l16', order: 16, title: "Amaliy loyiha: Restoran uchun to'liq brending", duration: '75 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '10': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "JSX va komponentlar — asoslar",               duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "Props va ma'lumot uzatish",                   duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "useState Hook — holat boshqarish",            duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "useEffect Hook — yon effektlar",              duration: '32 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "useRef, useMemo va useCallback",              duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "Custom Hooks yaratish",                       duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "Context API va global holat",                 duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "React Router v6 — sahifalar va navigatsiya", duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l11', order: 11, title: "API bilan ishlash va ma'lumot yuklash",     duration: '38 daqiqa',   free: true, completed: false },
      { id: 'l12', order: 12, title: "Formalar va validatsiya (React Hook Form)",  duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l13', order: 13, title: "Komponentlarni optimallashtirish",           duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l14', order: 14, title: "Testing: Jest va React Testing Library",     duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l15', order: 15, title: "Next.js bilan tanishuv",                    duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l16', order: 16, title: "TypeScript bilan React",                    duration: '45 daqiqa',   free: true, completed: false },
      { id: 'l17', order: 17, title: "Tailwind CSS bilan React stylish",          duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l18', order: 18, title: "Loyiha: Weather App (API integratsiyali)",  duration: '60 daqiqa',   free: true, completed: false },
      { id: 'l19', order: 19, title: "Loyiha: E-commerce sahifa yaratish",        duration: '75 daqiqa',   free: true, completed: false },
      { id: 'l20', order: 20, title: "Xulosa va keyingi qadamlar",                duration: '20 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
  ...
  '11': {
    ...
    lessons: [
      ...
      { id: 'l3', order: 3,  title: "Fayl tizimi va Event Loop tushunchasi",       duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l4', order: 4,  title: "Express.js bilan server yaratish",            duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l5', order: 5,  title: "Routing va Middleware",                       duration: '32 daqiqa',   free: true, completed: false },
      { id: 'l6', order: 6,  title: "REST API yaratish — CRUD operatsiyalar",      duration: '45 daqiqa',   free: true, completed: false },
      { id: 'l7', order: 7,  title: "Kirish tekshiruvi va xatolarni boshqarish",   duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l8', order: 8,  title: "MongoDB bilan ishlash — asoslar",             duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l9', order: 9,  title: "Mongoose ORM va sxemalar",                    duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l10', order: 10, title: "PostgreSQL va SQL asoslari",                 duration: '40 daqiqa',   free: true, completed: false },
      { id: 'l11', order: 11, title: "Prisma ORM bilan ishlash",                  duration: '38 daqiqa',   free: true, completed: false },
      { id: 'l12', order: 12, title: "Ma'lumotlar bazasi munosabatlari",           duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l13', order: 13, title: "JWT autentifikatsiya va avtorizatsiya",      duration: '45 daqiqa',   free: true, completed: false },
      { id: 'l14', order: 14, title: "Parollarni xavfsiz saqlash (bcrypt)",       duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l15', order: 15, title: "Fayl yuklash va cloud storage",             duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l16', order: 16, title: "Email yuborish (Nodemailer/Resend)",        duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l17', order: 17, title: "Vercel'ga deploy qilish",                   duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l18', order: 18, title: "Railway va Render'ga deploy qilish",        duration: '28 daqiqa',   free: true, completed: false },
      { id: 'l19', order: 19, title: "Docker bilan konteynerizatsiya asoslari",   duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l20', order: 20, title: "CI/CD va GitHub Actions",                   duration: '30 daqiqa',   free: true, completed: false },
      { id: 'l21', order: 21, title: "API xavfsizligi va best practices",         duration: '32 daqiqa',   free: true, completed: false },
      { id: 'l22', order: 22, title: "Performance va caching (Redis)",            duration: '35 daqiqa',   free: true, completed: false },
      { id: 'l23', order: 23, title: "Monitoring va logging",                     duration: '25 daqiqa',   free: true, completed: false },
      { id: 'l24', order: 24, title: "Loyiha: To'liq REST API va deploy",        duration: '90 daqiqa',   free: true, completed: false },
    ],
    whatYouLearn: [
