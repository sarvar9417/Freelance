  ...
  if (courseIds.length === 0) {
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Topshiriqlarni tekshirish</h1>
          <p className="text-gray-500 dark:text-white/40 text-sm mt-1">Tekshirilmagan topshiriqlar</p>
        </div>
        <div className="rounded-2xl p-12 text-center bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/10">
          <div className="text-5xl mb-4">📭</div>
          <p className="text-gray-500 dark:text-white/40 text-sm">Hali kurs yaratilmagan</p>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Topshiriqlarni tekshirish</h1>
          <p className="text-gray-500 dark:text-white/40 text-sm mt-1">Barcha topshirilgan ishlarni ko&apos;rib chiqing</p>
        </div>
        <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm"
          ...
          <span className="text-gray-500 dark:text-white/40">ta kutilmoqda</span>
        </div>
      </div>
