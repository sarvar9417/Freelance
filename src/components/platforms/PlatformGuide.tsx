...
const PLATFORMS: Platform[] = [
  ...
  },
  {
    id: 'kwork',
    name: 'Kwork',
    tagline: '🇷🇺 Rossiya platformasi — Fiverr ga o\'xshash, lekin MDH bozori uchun',
    logo: '🟢',
    color: 'text-emerald-400',
    bgColor: 'rgba(16,185,129,0.08)',
    borderColor: 'rgba(16,185,129,0.2)',
  ...
  },
  {
    id: 'freelancer',
    name: 'Freelancer.com',
    tagline: '🌍 Global platforma — dunyo bo\'ylab mijozlar va loyihalar',
    logo: '🌐',
    color: 'text-sky-400',
  ...
  },
  {
    id: 'workzilla',
    name: 'Workzilla',
    tagline: '⚡ Vazifalarga asoslangan — tez pul topish uchun rus platformasi',
    logo: '⚡',
    ...
    minLevel: 'Boshlang\'ich',
    pros: [
      'Kichik vazifalar — tez pul topish',
      'Ro\'yxatdan o\'tish oson va tez',
      'Rus tilidagi mijozlar ko\'p',
      'Minimal talablar talab qilinadi',
    ],
    cons: [
      'Katta loyihalar deyarli yo\'q',
      'Raqobat yuqori',
      'Faqat MDH bozori',
    ],
    steps: [
      { icon: '1️⃣', title: 'Ro\'yxatdan o\'ting', desc: 'Profil yarating va vazifalarni ko\'rib chiqing.' },
      { icon: '2️⃣', title: 'Vazifa toping', desc: 'O\'zingizga mos vazifani tanlang va taklif yuboring.' },
      { icon: '3️⃣', title: 'Bajarib oling', desc: 'Vazifani bajaring va darhol pulingizni oling.' },
    ],
    tips: [
      { text: 'Workzilla — yon pul uchun ideal, asosiy platforma sifatida foydalanmang' },
      { text: 'Tez bajariladigan vazifalarni qidiring — 30 daqiqa ichida pul ishlang' },
      { text: 'Kam raqobatli nishalarni topib, o\'sha yo\'nalishda ixtisoslashing' },
    ],
    bestFor: ['Kichik vazifalar', 'Matn terish', 'Rasm qayta ishlash', 'Ma\'lumotlar kiritish', 'Oddiy dizayn'],
    url: 'workzilla.ru',
  },
]
